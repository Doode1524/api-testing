            ...
            <TableBody>
              {props.cases.map((data) => (
                <StyledTableRow key={Object.keys(data)[0]}>
                  ...
                  <StyledTableCell align="right">{data[Object.keys(data)].confirmed}</StyledTableCell>
                  <StyledTableCell align="right">{data[Object.keys(data)].deaths}</StyledTableCell>
                  <StyledTableCell align="right">{data[Object.keys(data)].population}</StyledTableCell>
                </StyledTableRow>
              ))}
            </TableBody>
          </Table>
